...
## App's Skill Radar
- At the end, Max quickly mentioned about an App's Skill Radar which I thought was very interesting. I think this is appliable not only to Mobile Apps, but also to any modern startups (i.e. Website for delivery call, aka. Doordash/Palo Altos Delivery)
![](Radar.png)
